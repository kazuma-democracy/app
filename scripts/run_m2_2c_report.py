...
DEFAULT_IDENTITIES = ROOT / "artifacts" / "real-identity-pilot" / "entities.json"
DEFAULT_IDENTITY_REPORT = ROOT / "artifacts" / "real-identity-pilot" / "report.json"
...
def generate(
    *,
    ...
    if len(identities) != EXPECTED_COMPANY_COUNT:
        raise ValueError(f"M1.1 identity artifact contains {len(identities)} entities, expected 100")
